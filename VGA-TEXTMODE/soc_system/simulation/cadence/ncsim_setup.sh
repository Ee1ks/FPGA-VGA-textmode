...
# ACDS 18.1 625 win32 2021.02.10.17:42:52
...
mkdir -p ./libraries/onchip_memory2_0_s1_rsp_width_adapter/
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_width_adapter.sv"                                    -work onchip_memory2_0_s1_rsp_width_adapter -cdslib ./cds_libs/onchip_memory2_0_s1_rsp_width_adapter.cds.lib
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_address_alignment.sv"                                -work onchip_memory2_0_s1_rsp_width_adapter -cdslib ./cds_libs/onchip_memory2_0_s1_rsp_width_adapter.cds.lib
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_burst_uncompressor.sv"                               -work onchip_memory2_0_s1_rsp_width_adapter -cdslib ./cds_libs/onchip_memory2_0_s1_rsp_width_adapter.cds.lib
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/altera_avalon_sc_fifo.v"                                           -work onchip_memory2_0_s1_agent_rsp_fifo    -cdslib ./cds_libs/onchip_memory2_0_s1_agent_rsp_fifo.cds.lib   
